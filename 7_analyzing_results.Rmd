...
```{r, fig.width=16, fig.height=5, code_folding="Please show me the code!"}
...
data_neyman %>%
  ...
  rename(
    ...
    "Lower Bound of the 95% Neymanian Interval" = lower_bound_95,
    "Upper Bound of the 95% Neymanian Interval" = upper_bound_95,
    "Lower Bound of the 99% Neymanian Interval" = lower_bound_99,
    "Upper Bound of the 99% Neymanian Interval" = upper_bound_99
  ) %>%
  datatable(.)
```
